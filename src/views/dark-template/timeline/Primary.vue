<template>
  <v-card
    ...
    light
  >
    <v-card-text id="timeline">
      <content-section
        
        :title="detailed ? 'Working Experience' : 'My Experiences'"
      >
        <v-timeline
          dense
        >
  ...
  data      : () => ({
    ...
    items   : [
      ...
      // },
      {
        ...
        html : `
          <p style="margin-bottom:-2">
            <b>Current position: </b>  Office Staff / Full Stack Developer
          </p>
          As a web developer at <a href="http://www.hrd-s.com/about.html" target="_blank">HRD Singapore PTE LTD</a>,  I was also responsible for mentoring newly hired and re-assigned employees to help them acquire the necessary skills and knowledge to excel in their roles.<br/>
          <b>Responsibilities:</b>
          <ul>
            <li>Maintain web system for in house use for the company and the sister Companies</li>
            <li>To create a web system or api to cater the needs of the production</li>
            <li>Provide guidance and support to newly hired and re-assigned employees as a Full-stack development mentor</li>
          </ul>
          
        `,
        image    : 'img/timeline/HRD_img.jpg',
      ...
      },
      {
        ...
        html : `
        During my internship at <a href="https://www.artesyn.com/" target="_blank">Artesyn Embedded Power</a> currently known today(2023) <a href="https://www.advancedenergy.com/about-us/" target="_blank">Advanced Energy</a>,
        <br/>
        I was a part of the PDS (Product Design Specification) Department.
        ...
        `,
        // icon: 'mdi-flash',
        image    : 'img/timeline/artesyn.png',
        iconImage: 'img/timeline/artesyn-logo.png',
        imageHeight:150
      },
    ],
  }),
